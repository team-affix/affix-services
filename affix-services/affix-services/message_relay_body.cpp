...
message_relay_body::message_relay_body(
	...
	affix_base::data::serializable(m_client_identity, m_targeted_agent_identifier, m_payload, m_path)
{
...
message_relay_body::message_relay_body(
	...
	m_targeted_agent_identifier(a_targeted_agent_identifier),
	m_payload(a_payload),
	m_path(a_path)
{
...
message_relay_body::message_relay_body(
	...
	message_relay_body(
		...
		a_message_rqt_relay_body.m_targeted_agent_identifier,
