...
message_index_body::message_index_body(
	...
	affix_base::data::serializable(m_client_identities, m_agents)
{
...
message_index_body::message_index_body(
	...
	message_index_body(a_message_rqt_index_body.m_client_identities, a_message_rqt_index_body.m_agents)
{
