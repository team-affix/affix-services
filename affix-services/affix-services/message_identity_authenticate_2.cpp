...
serialization_result message_identity_authenticate_2::try_serialize(byte_buffer& a_data) {
...
serialization_result message_identity_authenticate_2::try_deserialize(byte_buffer& a_data, message_identity_authenticate_2& a_message) {
