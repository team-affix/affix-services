...
{
    public partial class Page_AddAccountToMachineP2PContract : UserControl
    {
        System.Windows.Forms.Timer Timer_Animate = new Timer();
        public Page_AddAccountToMachineP2PContract()
        {
            InitializeComponent();
        ...
        void Perform()
        {
            Enabled = false;
            lblError.Text = "";
            Timer_Animate = App.Methods.Timer_MakeLoadingAnimation(pnlLoading, 2);
            Timer_Animate.Start();

            App.Methods.void_AddAccountToMachineP2PContract(txtMachineID.textBox.Text, flags =>
            {
